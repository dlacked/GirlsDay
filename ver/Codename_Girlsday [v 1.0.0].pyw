...
def userbetsetting1(): #첫 번째 베팅 설정 관리
    ...
    alert2 = Label(text = "베팅 최소금액은 백만 원입니다.", font = ("맑은 고딕", 10), fg = "white", bg = "#00B41E")
    alert2.place(x = 30, y = 175)
...
def userbetsys1(): #첫 번째 베팅 시스템
    global usermoney
    global betmoney
    global usermoneylabel, betmoneylabel
...
def ingame2():
    global user2, betmoneylabel, alert3, alert4, cpumoneylabel
    betmoneylabel.destroy()
    cpumoneylabel.destroy()
    alert4.destroy()
    cpumoneylabel = Label(text = f"CPU: {cpumoney}", font = ("맑은 고딕", 10), fg = "white", bg = "#00B41E")
...
def cpubetsetting2():
    global cpumoney
    global betmoney
    global cpumoneylabel, betmoneylabel, alert5
    alert5 = Label(text = "CPU가 베팅 중입니다...", font = ("맑은 고딕", 10), fg = "white", bg = "#00B41E")
    alert5.place(x = 55, y = 185)
    alert5.after(5000, end)
    bet = randrange(1000000, cpumoney+1)
    betmoney += bet
    cpumoney -= bet
    
def end():
    global cpu1, cpu2, usermoney, betmoney, cpumoney, usermoneylabel, cpumoneylabel, betmoneylabel, alert5, worlimage, rebutton
    alert5.destroy()
    cpumoneylabel.destroy()
    betmoneylabel.destroy()
    cpumoneylabel = Label(text = f"CPU: {cpumoney}", font = ("맑은 고딕", 10), fg = "white", bg = "#00B41E")
...
def main(): #프로그램 기본 세팅 함수
    ...
    usermoney = randrange(8000000, 12000000)
    cpumoney = randrange(8000000, 12000000)
    betmoney = 0
